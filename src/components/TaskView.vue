<template>
  <div class="task-container">
    <input type="checkbox" title="Marcar ou desmarcar como tarefa concluída" />

    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>

    <button title="Deletar comentário" class="trash-button">
      <svg
        width="16"
        height="16"
        viewBox="0 0 13 14"
...
.task-container .trash-button:hover svg path {
  fill: var(--red);
}

.task-container input[type='checkbox']:checked + p {
  color: var(--gray-300);
